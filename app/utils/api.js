 ...
 */
export async function get(path, token, suppressRedBox) {
  return bodyOf(request('get', path, null, suppressRedBox, token));
}
 ...
 * @returns {Promise}  of response body
 */
export async function post(path, body, token, suppressRedBox) {
  return bodyOf(request('post', path, body, suppressRedBox, token));
}
 ...
 * @returns {Promise}  of response body
 */
export async function put(path, body, token, suppressRedBox) {
  return bodyOf(request('put', path, body, suppressRedBox, token));
}
 ...
 * @returns {Promise}  of response body
 */
export async function del(path, token, suppressRedBox) {
  return bodyOf(request('delete', path, null, suppressRedBox, token));
}
 ...
 * @param {Boolean} suppressRedBox If true, no warning is shown on failed request
 */
export async function request(method, path, body, suppressRedBox, token) {
  try {
